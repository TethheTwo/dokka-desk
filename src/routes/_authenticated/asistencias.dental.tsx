...
function AsistenciaDentalPage() {
  return (
    <div className="min-h-screen bg-[var(--app-bg)] text-foreground">
      <AppTopBar />
      <PageHeader title="Asistencia Dental" subtitle="Registrar nueva asistencia dental." />
...
const TEXT_FIELDS: { key: string; label: string; placeholder: string }[] = [
  ...
  { key: "tipoAsistencia", label: "Tipo de asistencia", placeholder: "Tipo de asistencia" },
];
  ...
  return (
    <div className="bg-card rounded-md shadow-sm border border-border overflow-hidden">
      ...
      <div className="px-6 py-5 border-b border-border flex items-center justify-between gap-3">
        <h2 className="text-sm font-semibold text-foreground">Registrar nueva asistencia dental</h2>
        <button
          type="button"
